...
interface UserContactProps {
  ...
  read: boolean;
  countMessage: number;
  typeLayout: 'CURRENT_CONTACT' | 'USER_CONTACT';
}

export function UserContactLayout(props: UserContactProps): JSX.Element {
  const { image, name, online, lastMessage, lastAtCreate, read, countMessage, typeLayout } = props;
  return (
    <>
      {(typeLayout === 'USER_CONTACT' && (
        <article
        ...
        >
          <div className='flex items-center'>
            ...
            <div className='ml-4'>
              ...
              {(online && <p className='text-amber-500 text-sm'>online</p>) || (
